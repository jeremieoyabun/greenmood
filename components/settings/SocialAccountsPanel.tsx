...
export function SocialAccountsPanel() {
  ...
  const handleConnect = (accountId: string) => {
    ...
    if (account.platform === 'instagram') {
      ...
      window.location.href = `https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=77cfx3q0hjhjdk&redirect_uri=${encodeURIComponent('https://app.greenmood.be/api/auth/callback/linkedin')}&scope=openid%20profile%20w_member_social%20w_organization_social%20rw_organization_admin&state=${accountId}`
    }
  }
